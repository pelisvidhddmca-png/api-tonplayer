...
|   - Se mantiene independiente de Alpha
|
|--------------------------------------------------------------------------
| Secrets:
|
...
| Ejemplo:
|
| SOURCE_URL=https://dominio.com
|
| genera:
|
| https://dominio.com/embed/api.php
| ?action=details
| &id=44956
| &type=movie
|
...
async function fetchAlpha(
  ...
  try {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Si llega HTML en lugar de JSON, devolvemos
      ...
      createSSEStream(
        async send => {
          ...
          */
          ...
          |--------------------------------------------------------------------------
          |
          | Si Alpha no responde o tiene 4 o menos,
          | se consulta Beta.
          |--------------------------------------------------------------------------
          */
